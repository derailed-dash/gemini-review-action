...
def tune_open_model(
    ...
    validation_ds = types.TuningValidationDataset(gcs_uri=validation_dataset) if validation_dataset else None
    ...
    if tuning_mode == "FULL":
        ...
        raise ValueError(f"Unsupported tuning mode: {tuning_mode}. Supported modes are: FULL, PEFT_ADAPTER.")
    adapter_map = {
        1: "ADAPTER_SIZE_ONE",
        2: "ADAPTER_SIZE_TWO",
        4: "ADAPTER_SIZE_FOUR",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tuning_mode", choices=("FULL", "PEFT_ADAPTER"), required=True)
    parser.add_argument(
        "--adapter_size",
        type=int,
        choices=(1, 4, 8, 16, 32),
