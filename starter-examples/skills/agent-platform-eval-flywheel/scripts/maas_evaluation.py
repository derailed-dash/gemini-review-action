...
def run_evaluation(
    *,
    ...
    try:
        ...
        raise RuntimeError(f"Error running evaluation for MaaS model: {model_id}") from e

    return maas_eval_result


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate a MaaS model using Agent Platform Evaluation.")
